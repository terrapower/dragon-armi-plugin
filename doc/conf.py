...
htmlhelp_basename = "ARMIDragonPlugindoc"
...
latex_documents = [
    (
        master_doc,
        "ARMIDragonPlugin.tex",
        "ARMI Dragon Plugin Documentation",
        "TerraPower, LLC",
        "manual",
    )
]
...
man_pages = [(master_doc, "armiDragon", "ARMI Dragon Documentation", [author], 1)]
